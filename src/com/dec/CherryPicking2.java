 ...
 */
public class CherryPicking2 {
    public static void main(String[] args) {
        CherryPicking2 cherryPicking2= new CherryPicking2();
        int[][] grid = {{3, 1, 1}, {2, 5, 1}, {1, 5, 5}, {2, 1, 1}};
        int numOfCherries = cherryPicking2.cherryPickup(grid);
        System.out.println(numOfCherries);
    }
